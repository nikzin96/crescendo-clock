...
class Display {
    ...
    const uint16_t display_light_thd_down[DISPLAY_BRIGHTNESS_LEVELS_NR] = {35, 50, 70, 100};
    const uint16_t display_light_thd_up[DISPLAY_BRIGHTNESS_LEVELS_NR] = {45, 55, 90, 120};
